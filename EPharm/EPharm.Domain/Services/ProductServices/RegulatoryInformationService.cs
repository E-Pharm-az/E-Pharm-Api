...
public class RegulatoryInformationService(IRegulatoryInformationRepository regulatoryInformationRepository, IMapper mapper) : IRegulatoryInformationService
{
    public async Task<IEnumerable<GetRegulatoryInformationDto>> GetAllCompanyRegulatoryInformationAsync(int pharmaCompanyId)
    {
        var regulatoryInformation = await regulatoryInformationRepository.GetAllCompanyRegulatoryInformationAsync(pharmaCompanyId);
    ...
    public async Task<GetRegulatoryInformationDto> AddCompanyRegulatoryInformationAsync(int pharmaCompanyId, CreateRegulatoryInformationDto regulatoryInformationDto)
    {
        try
        {
    ...
    public async Task<bool> UpdateCompanyRegulatoryInformationAsync(int regulatoryInformationId, CreateRegulatoryInformationDto regulatoryInformationDto)
    {
