...
public class SpecialRequirementService(ISpecialRequirementRepository specialRequirementRepository, IMapper mapper) : ISpecialRequirementService
{
    public async Task<IEnumerable<GetSpecialRequirementDto>> GetAllCompanySpecialRequirementsAsync(int pharmaCompanyId)
    {
        var specialRequirements = await specialRequirementRepository.GetAllCompanySpecialRequirementsAsync(pharmaCompanyId);
    ...
    public async Task<GetSpecialRequirementDto> AddCompanySpecialRequirementAsync(int pharmaCompanyId, CreateSpecialRequirementDto specialRequirementDto)
    {
        try
        {
    ...
    public async Task<bool> UpdateCompanySpecialRequirementAsync(int specialRequirementId, CreateSpecialRequirementDto specialRequirement)
    {
