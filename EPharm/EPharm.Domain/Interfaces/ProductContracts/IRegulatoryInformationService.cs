...
public interface IRegulatoryInformationService
{
    ...
    Task<GetRegulatoryInformationDto> AddCompanyRegulatoryInformationAsync(int pharmaCompanyId,
        CreateRegulatoryInformationDto regulatoryInformationDto);

    Task<bool> UpdateCompanyRegulatoryInformationAsync(int regulatoryInformationId,
        CreateRegulatoryInformationDto regulatoryInformationDto);
